package com.project.sso.keycloakservice;
...
public class KeycloakService {
    ...
    private final String realmAdmin = "knowledgefactory-realm";
    private final String adminClientId = "knowledgefactory-client";
